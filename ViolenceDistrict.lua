...
local success, result = pcall(function()
    ...
    local functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/Soekki/SOEKKI/refs/heads/main/main_functions.lua"))()
    if not functions then
        error("Failed to load main_functions.lua")
    end
    
    -- Загружаем UI
    local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/Soekki/SOEKKI/refs/heads/main/main_ui.lua"))()
    if not ui then
